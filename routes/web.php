...
Route::get('/', [ProfessionistaController::class, 'professionisti'])->name('login'); 

Route::get('/professionista/{slug}', [ProfessionistaController::class, 'show'])->name('mostra_professionista');

Route::post('/prenota/{id}', [PrenotazioniController::class, 'crea_prenotazione'])
