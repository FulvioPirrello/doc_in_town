        ...
        <a class="left_item" href="/">
            <button>
                <svg class="dit_logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 160" role="img" aria-labelledby="title desc" class="logo-docintown">
                    <path d="M80 8 a72 72 0 1 0 0 144 a72 72 0 1 0 0-144" fill="white" stroke="black" stroke-width="6"/>
                    <path d="M68 38 a4 4 0 0 1 4-4h16a4 4 0 0 1 4 4v30h30a4 4 0 0 1 4 4v16a4 4 0 0 1-4 4h-30v30a4 4 0 0 1-4 4h-16a4 4 0 0 1-4-4v-30h-30a4 4 0 0 1-4-4v-16a4 4 0 0 1 4-4h30z M74 50h12v24h24v12h-24v24h-12v-24H50v-12h24z" fill="black" fill-rule="evenodd"/>
                </svg>
            </button>
            <div class="title">DOC IN TOWN</div>
        </a>

        <button class="hamburger-nav" id="mobile-menu-btn">
            <span></span>
            <span></span>
            <span></span>
        </button>

        <div class="right_item" id="main-menu">
            @if(!Auth::check())
